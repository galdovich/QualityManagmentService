...
### Маршрутный карты
Маршрутная карта (далее-МК) относится к числу обязательных технологических документов. МК содержит описание последовательности выполнения технологических операций. На нашей фирме это технология работает на формальном уровне. 
<p align="center">
  <img src="./img/routeMap.jpg" alt="Size Limit CLI" width="510">
</p>
Данная система позволяет создавать МК и предоставлять рабочим доступ к ней. 
